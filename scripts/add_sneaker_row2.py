...
<div class="main-wrapper">
    ...
    <!-- ALL SNEAKERS / THE SNEAKER VAULT SECTION (2 FULL PRODUCT ROWS - 8 PRODUCTS FROM SCREENSHOT) -->
    <section class="sneaker-vault-section">
        <div class="container-inner">
            ...
            <div class="grid-4-products">
                ...
                <!-- ROW 1 - PRODUCT 1: NIKE AIR FORCE 1 TRIPLE BLACK -->
                <article class="product-card-clean">
                ...
                <!-- ROW 1 - PRODUCT 2: ADIDAS SAMBA OG -->
                <article class="product-card-clean">
                    <span class="badge-pill-maroon">MONSOON SALE</span>
                    <div class="product-card-clean__img">
                        <div class="card-watermark">KM</div>
                ...
                <!-- ROW 1 - PRODUCT 3: JORDAN 1 MID DUSTY PEACH -->
                <article class="product-card-clean">
                    <span class="badge-pill-maroon">MONSOON SALE</span>
                    <div class="product-card-clean__img">
                        <div class="card-watermark">KM</div>
                ...
                <!-- ROW 1 - PRODUCT 4: JORDAN 1 LOW PALE IVORY -->
                <article class="product-card-clean">
                    <span class="badge-pill-black">INSTANT SHIP</span>
                    <div class="product-card-clean__img">
                        <div class="card-watermark">KM</div>
                ...
                <!-- ROW 2 - PRODUCT 5: JORDAN 1 LOW WHITE ALUMINUM (WOMEN'S) -->
                <article class="product-card-clean">
                    <span class="badge-pill-black">INSTANT SHIP</span>
                    <div class="product-card-clean__img">
                        <div class="card-watermark">KM</div>
                ...
                <!-- ROW 2 - PRODUCT 6: AIR JORDAN 1 RETRO HIGH OG BLACK TOE REIMAGINED -->
                <article class="product-card-clean">
                    <span class="badge-pill-black">INSTANT SHIP</span>
                    <div class="product-card-clean__img">
                        <div class="card-watermark">KM</div>
                ...
                <!-- ROW 2 - PRODUCT 7: JORDAN 1 LOW BRED TOE 2.0 -->
                <article class="product-card-clean">
                    <span class="badge-pill-black">INSTANT SHIP</span>
                    <div class="product-card-clean__img">
                        <div class="card-watermark">KM</div>
                ...
                <!-- ROW 2 - PRODUCT 8: ADIDAS SAMBA OG NIGHT NAVY GUM -->
                <article class="product-card-clean">
                    <span class="badge-pill-black">INSTANT SHIP</span>
                    <div class="product-card-clean__img">
                        <div class="card-watermark">KM</div>
...
print("UPDATED index.html with 8 products (2 rows) in All Sneakers section!")
