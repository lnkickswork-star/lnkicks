...
const COMMAND_ENTRIES: { label: string; href: string; group: string; keywords: string }[] = [
  ...
  { label: 'Marketing Home', href: '/admin/marketing', group: 'Marketing', keywords: 'marketing growth suite overview' },
  { label: 'Email Marketing', href: '/admin/marketing/email', group: 'Marketing', keywords: 'email campaigns klaviyo mailchimp newsletter automation' },
  { label: 'WhatsApp Marketing', href: '/admin/marketing/whatsapp', group: 'Marketing', keywords: 'whatsapp messages meta business templates campaigns' },
