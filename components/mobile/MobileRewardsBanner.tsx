      ...
      <div style={{ padding: `0 ${theme.spacing.sectionPadding}px` }}>
        ...
        >
          ...
          >
            <div
              style={{
                ...
                padding: `${theme.spacing.md}px ${theme.spacing.cardPadding}px`,
                border: `1px solid ${theme.colors.grey150}`,
              }}
            >
              <ul
              ...
              >
                ...
                >
                  <span
                    ...
                    style={{
                      ...
                      height: 16,
                      borderRadius: '50%',
                      background: isLoggedIn ? ACCENT_GREEN : theme.colors.black,
                  ...
                  Create your account today and instantly receive{' '}
                  <strong style={{ fontWeight: theme.fontWeight.bold }}>₹50</strong> in your wallet.
                </li>
                <li
                  style={{
                    display: 'flex',
                ...
                >
                  ...
                  Invite your first friend and earn another{' '}
                  <strong style={{ fontWeight: theme.fontWeight.bold }}>₹50</strong>.
                </li>
                <li
                  style={{
                    display: 'flex',
                ...
                >
                  ...
                  Complete your first order to unlock{' '}
                  <strong style={{ fontWeight: theme.fontWeight.bold }}>₹100</strong> Wallet Cashback.
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            ...
            >
              {[
                'Wallet rewards are applicable only on prepaid orders.',
                'Referral reward unlocks after your friend\u2019s first successful order.',
                'Wallet rewards are valid for 90 days.',
              ].map((term, i) => (
                <span
                  key={i}
                  style={{
                ...
                >
                  <span aria-hidden style={{ color: theme.colors.grey400 }}>•</span>
                  {term}
                </span>
              ))}
            </div>
