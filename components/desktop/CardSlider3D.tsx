...
/**
 * CardSlider3D — luxury editorial 3D coverflow slider.
 *
 * Originally the homepage's Trending This Week coverflow. Now restored
 * as a standalone component placed immediately below the Hero Banner,
 * exactly as it was before the floating-product-slider refactor.
 *
...
export default function CardSlider3D() {
  ...
  return (
    <section
      aria-label="Featured Drops — premium 3D coverflow of curated sneakers"
      style={{
        position: 'relative',
        paddingTop: '96px',
        paddingBottom: '120px',
