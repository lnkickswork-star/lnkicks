...
os.makedirs(os.path.join(app_dir, "search"), exist_ok=True)
os.makedirs(os.path.join(app_dir, "filters"), exist_ok=True)

# 1. app/search/page.tsx
search_page_code = """'use client';
...
with open(os.path.join(app_dir, "search", "page.tsx"), "w", encoding="utf-8") as f:
    f.write(search_page_code)

print("Created app/search/page.tsx!")

# 2. app/filters/page.tsx
filters_page_code = """'use client';
...
with open(os.path.join(app_dir, "filters", "page.tsx"), "w", encoding="utf-8") as f:
    f.write(filters_page_code)

print("Created app/filters/page.tsx!")
