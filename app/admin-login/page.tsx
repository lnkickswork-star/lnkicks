    ...
    <ResponsiveAppLayout title="ADMIN PORTAL">
      <div style={{ maxWidth: '420px', margin: '40px auto', background: '#ffffff', borderRadius: '28px', padding: '36px', border: '2px solid #111111', boxShadow: '0 12px 32px rgba(0,0,0,0.08)' }}>
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          <div style={{ fontFamily: "var(--font-playfair), serif", fontSize: '28px', fontWeight: 700, color: '#111111' }}>LNKICKS</div>
        ...
        <form onSubmit={handleAdminLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button type="submit" style={{ width: '100%', padding: '14px', background: '#FF3B30', color: '#ffffff', borderRadius: '30px', fontFamily: "var(--font-oswald), sans-serif", fontSize: '14px', fontWeight: 700, border: 'none', cursor: 'pointer', letterSpacing: '0.08em', marginTop: '10px' }}>
            AUTHENTICATE ADMIN →
          </button>
        </form>
      </div>
