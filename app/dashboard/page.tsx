  ...
  return (
    <ResponsiveAppLayout title="ADMIN DASHBOARD">
      ...
      <div style={{ background: '#111111', borderRadius: '24px', padding: '16px 24px', color: '#ffffff', marginBottom: '32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
        <div style={{ fontFamily: "var(--font-oswald), sans-serif", fontSize: '18px', fontWeight: 800, letterSpacing: '0.1em' }}>
      ...
      <h1 style={{ fontFamily: "var(--font-oswald), sans-serif", fontSize: '32px', fontWeight: 800, textTransform: 'uppercase', color: '#111111', marginBottom: '28px' }}>Executive Overview</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '20px', marginBottom: '40px' }}>
        {stats.map((s, i) => (
          <div key={i} style={{ background: '#ffffff', borderRadius: '20px', padding: '24px', border: '1px solid #EBEBEB', boxShadow: '0 4px 14px rgba(0,0,0,0.03)' }}>
            ...
            <div style={{ fontFamily: "var(--font-oswald), sans-serif", fontSize: '28px', fontWeight: 800, color: '#111111' }}>{s.value}</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
        <div style={{ background: '#ffffff', borderRadius: '24px', padding: '28px', border: '1px solid #EBEBEB' }}>
          <h3 style={{ fontFamily: "var(--font-oswald), sans-serif", fontSize: '20px', fontWeight: 800, color: '#111111', margin: '0 0 12px' }}>Products &amp; Catalog</h3>
        ...
        <div style={{ background: '#ffffff', borderRadius: '24px', padding: '28px', border: '1px solid #EBEBEB' }}>
          <h3 style={{ fontFamily: "var(--font-oswald), sans-serif", fontSize: '20px', fontWeight: 800, color: '#111111', margin: '0 0 12px' }}>Orders &amp; Fulfillment</h3>
