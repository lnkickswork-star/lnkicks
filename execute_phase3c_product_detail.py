...
product_slug_dir = os.path.join(app_dir, "product", "[slug]")
os.makedirs(product_slug_dir, exist_ok=True)

# 1. app/product/[slug]/page.tsx
product_detail_code = """'use client';
...
with open(os.path.join(product_slug_dir, "page.tsx"), "w", encoding="utf-8") as f:
    f.write(product_detail_code)

with open(os.path.join(app_dir, "product-detail", "page.tsx"), "w", encoding="utf-8") as f:
    f.write(product_detail_code)

print("Created app/product/[slug]/page.tsx and updated app/product-detail/page.tsx!")
